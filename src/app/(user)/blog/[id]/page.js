import { showblogs } from "../../../admin/blog/servis";
    ...
    return (
        <div>
            <div className="flex flex-row" style={{ padding: 60 }}>
                ...
                <div style={{ marginLeft: 50 }} className="flex flex-col">
                ...
                <form action={komentar}>
                    ...
                    <div className="bg-[#e8f0fe] rounded-[24px] p-6 mb-10 shadow-sm">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            {/* Textarea dengan efek Inset Shadow */}
                            <textarea
                            ...
                            />
                            <input defaultValue={id} name="blog_id" hidden/>

                            {/* Tombol Kirim (Statis, belum memicu submit apa pun) */}
                            <button
                                type="submit"
